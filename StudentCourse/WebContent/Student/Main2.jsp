        ...
        <header class="masthead">
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    ...
                    <c:forEach var ="loginResult" items="${loginResult}">
                        <h1 class="text-uppercase text-white font-weight-bold">${loginResult} 님 환영합니다.</h1>
                        </c:forEach>
                        <hr class="divider my-4" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 font-weight-light mb-5">취업으로 가는 가장 빠른 선택 인천일보 아카데미</p>
                        <a class="btn btn-primary btn-xl js-scroll-trigger" href="/StudentCourse/Course/CourseList">수강신청</a>
                    </div>
                </div>
            </div>
        </header>
